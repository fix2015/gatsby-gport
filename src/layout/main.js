...
import { AppBar, Box, Button, Container, fade, IconButton, Toolbar } from '@material-ui/core'
        ...
        <AppBar>
          <Container>
            <Toolbar>
              ...
              <Box mr={1}>
                <Link to={`/search?text=${search}`} className={classes.main} state={{ fromFeed: false }}>
